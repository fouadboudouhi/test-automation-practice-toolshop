...
| UI-SM-06 | UI | smoke | ui-tests/smoke/categories_dropdown.robot | Categories Dropdown öffnet | Dropdown klickbar, Entries sichtbar |
| UI-SM-07 | UI | smoke | ui-tests/smoke/contact_route.robot | Contact Seite erreichbar | Navigation /contact, Heading/Form sichtbar |
| UI-SM-08 | UI | smoke | ui-tests/smoke/filters_panel_has_brands.robot | Brand Filter vorhanden | Mind. 1 brand checkbox sichtbar |
| UI-SM-09 | UI | smoke | ui-tests/smoke/filters_panel_has_categories.robot | Category Filter vorhanden | Mind. 1 category checkbox sichtbar |
| UI-SM-10 | UI | smoke | ui-tests/smoke/login_page_fields.robot | Login Felder vorhanden | Email+Password Felder sichtbar |
| UI-SM-11 | UI | smoke | ui-tests/smoke/privacy_route.robot | Privacy Seite erreichbar | /privacy heading sichtbar |
| UI-SM-12 | UI | smoke | ui-tests/smoke/product_details_add_to_cart_visible.robot | Details: Add to cart sichtbar | Erstes Produkt öffnen, Button sichtbar |
| UI-SM-13 | UI | smoke | ui-tests/smoke/products_have_images.robot | Product Thumbnails sichtbar | Erste Card hat img sichtbar |
| UI-SM-14 | UI | smoke | ui-tests/smoke/products_have_prices.robot | Product Price sichtbar | Erste Card zeigt Preis (z.B. €) |
| UI-SM-15 | UI | smoke | ui-tests/smoke/products_route_is_reachable.robot | /products erreichbar | Direkt /products öffnet, Cards sichtbar |
